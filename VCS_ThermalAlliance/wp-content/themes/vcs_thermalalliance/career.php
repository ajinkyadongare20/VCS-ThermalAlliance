        ...
        <div class="container py-5">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb animated slideInRight mb-0">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Careers at VCS ThermalAlliance – Current Opportunities</li>
                </ol>
            </nav>
        </div>
    </div>
        ...
        <div class="container py-5">
            ...
            <div class="row g-4">
                <div class="col-lg-4 wow fadeInUp" data-wow-delay="0.2s">
                    <div class="career-item">
                        <div class="career-img">
                            <img src="<?php bloginfo('template_directory'); ?>/img/career/career.jpg" class="career-img-fluid w-100" alt="HVAC Project Engineer">
                        </div>
                 ...
                 <div class="col-lg-4 wow fadeInUp" data-wow-delay="0.2s">
                    <div class="career-item">
                        <div class="career-img">
                            <img src="<?php bloginfo('template_directory'); ?>/img/career/career.jpg" class="career-img-fluid w-100" alt="Electrical Supervisor">
                        </div>
                        <div class="career-heading ms-2 my-3">
                ...
                <div class="col-lg-4 wow fadeInUp" data-wow-delay="0.4s">
                    <div class="career-item">
                        <div class="career-img">
                            <img src="<?php bloginfo('template_directory'); ?>/img/career/career.jpg" class="career-img-fluid w-100" alt="Firefighting Design Engineer">
                        </div>
                        <div class="career-heading ms-2 my-3">
                ...
                <div class="col-lg-4 wow fadeInUp" data-wow-delay="0.6s">
                    <div class="career-item">
                        <div class="career-img">
                            <img src="<?php bloginfo('template_directory'); ?>/img/career/career.jpg" class="career-img-fluid w-100" alt="Cleanroom Project Coordinator">
                        </div>
                        <div class="career-heading ms-2 my-3">
                ...
                <div class="col-lg-4 wow fadeInUp" data-wow-delay="0.4s">
                    <div class="career-item">
                        <div class="career-img">
                            <img src="<?php bloginfo('template_directory'); ?>/img/career/career.jpg" class="career-img-fluid w-100" alt="Sales Engineer">
                        </div>
                        <div class="career-heading ms-2 my-3">
