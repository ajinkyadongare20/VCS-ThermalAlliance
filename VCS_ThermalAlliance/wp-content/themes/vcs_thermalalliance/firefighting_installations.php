                    ...
                    <div class="tab-content">
                        <div id="ProjectsTab-1" class="tab-pane fade show p-0 active">
                            <div class="projects-item">
                                <img src="<?php bloginfo('template_directory'); ?>/img/service-2.jpg" class="img-fluid about-img-fluid" alt="Cleanroom HVAC">
                                <div class="projects-content bg-white p-4">
                                    <h4 class="mb-3">Cleanroom HVAC Installations</h4>
                                    <p class="mb-4">
                                        VCS ThermalAlliance delivers ultra-clean HVAC systems tailored for pharmaceutical and semiconductor cleanrooms. Our systems maintain strict temperature, humidity, and air quality control to ensure contamination-free environments compliant with international standards and protocols. We also offer chilled water systems, VRF units, HEPA filtration, ductable splits, and BMS-integrated controls for hospitals, laboratories, and ICUs.
                                    </p>
                        ...
                        <div id="ProjectsTab-2" class="tab-pane fade show p-0">
                            <div class="projects-item">
                                <img src="<?php bloginfo('template_directory'); ?>/img/project-2.jpg" class="img-fluid about-img-fluid" alt="Turnkey Electrical">
                                <div class="projects-content bg-white p-4">
                                    <h4 class="mb-3">Turnkey Electrical Systems</h4>
                                    <p class="mb-4">
                                        From design to commissioning, we offer comprehensive electrical system implementations for commercial and industrial facilities. Our services include panel fabrication, lighting and power layouts, cabling, earthing, lightning protection, BMS integration, energy audits, retrofitting, and safety compliance to ensure efficient and safe operations.
                                    </p>
                                    <a class="btn btn-primary py-2 px-4" href="#">Read More</a>
                                </div>
                            </div>
                        ...
                        <div id="ProjectsTab-3" class="tab-pane fade show p-0">
                            <div class="projects-item">
                                <img src="<?php bloginfo('template_directory'); ?>/img/project-3.jpg" class="img-fluid about-img-fluid" alt="Fire Safety">
                                <div class="projects-content bg-white p-4">
                                    <h4 class="mb-3">Fire Safety Implementations</h4>

                                    <h5 class="text-primary mt-3">Our Firefighting Systems Cover:</h5>
                                    <ul class="mb-4">
                                        <li>Fire Hydrant & Hose Reel Systems</li>
                                        <li>Automatic Sprinkler Systems (Wet, Dry, Deluge)</li>
                                        <li>Gas Suppression Systems (FM-200, NOVEC 1230, CO<sub>2</sub>)</li>
                                        <li>Smoke Detection, Fire Alarm & Voice Evacuation Systems</li>
                                        <li>Pump Room Design & Fire Water Storage</li>
                                        <li>Fire Doors, Fire Curtains & Compartmentalization</li>
                                    </ul>
                        ...
                        <div id="ProjectsTab-4" class="tab-pane fade show p-0">
                            <div class="projects-item">
                                <img src="<?php bloginfo('template_directory'); ?>/img/project-4.jpg" class="img-fluid about-img-fluid" alt="Industrial HVAC">
                                <div class="projects-content bg-white p-4">
                                    <h4 class="mb-4">HVAC Systems for Industries</h4>
                                    <p class="mb-4">
                                        Our industrial HVAC solutions deliver optimized temperature, ventilation, and humidity control for factories and large-scale units. We focus on energy-efficient operations, low maintenance needs, and system designs that support 24/7 functionality in manufacturing and process-driven environments.
                                    </p>
                                    <a class="btn btn-primary py-2 px-4" href="#">Read More</a>
                                </div>
                            </div>
